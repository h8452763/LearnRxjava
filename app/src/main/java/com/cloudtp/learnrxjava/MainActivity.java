...
import com.cloudtp.learnrxjava.utils.ActivityUtils;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.observer_patten) {

        } else if (id == R.id.api_introduce) {
            //api介绍 使用realm数据库


        } else if (id == R.id.application_screen) {
